...
def md_to_docx(md_path, out_path, diagrams_dir):
    ...
    doc.core_properties.title = "Scaffold Report HTML_MeetingProtokol Backend"

    # Заголовок документа (18 пт, жирный, по центру)
    add_document_title(doc, "Scaffold Report hmp-backend")
...
def main():
    ...
    md_path = project_root / "code" / "hmp-backend" / "SCAFFOLD_REPORT.md"
    diagrams_dir = project_root / "code" / "hmp-backend" / "diagrams"
    diagrams_dir.mkdir(parents=True, exist_ok=True)
    out_path = md_path.parent / "SCAFFOLD_REPORT.docx"
