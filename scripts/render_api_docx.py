...
def md_to_docx(md_path, out_path, diagrams_dir):
    ...
    doc.core_properties.title = "REST API HTML_MeetingProtokol"

    # Заголовок документа (18 пт, жирный, по центру)
    add_document_title(doc, "REST API HTML_MeetingProtokol")
...
def main():
    ...
    md_path = project_root / "artifacts" / "09-api" / "API.md"
    diagrams_dir = project_root / "artifacts" / "09-api" / "diagrams"
    diagrams_dir.mkdir(parents=True, exist_ok=True)
    out_path = md_path.parent / "API.docx"
