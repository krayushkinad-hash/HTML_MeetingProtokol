...
def md_to_docx(md_path, out_path, diagrams_dir):
    ...
    doc.core_properties.title = "Traceability Matrix HTML_MeetingProtokol"

    # Заголовок документа (18 пт, жирный, по центру)
    add_document_title(doc, "Traceability Matrix HTML_MeetingProtokol")
...
def main():
    ...
    md_path = project_root / "artifacts" / "10-traceability" / "TRACEABILITY.md"
    diagrams_dir = project_root / "artifacts" / "10-traceability" / "diagrams"
    diagrams_dir.mkdir(parents=True, exist_ok=True)
    out_path = md_path.parent / "TRACEABILITY.docx"
