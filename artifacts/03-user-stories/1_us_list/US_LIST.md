...
- **Status:** Done (E172)
- **Файл:** `US_087.md`
- **Описание:** Кнопка ☆ / ⭐ для пометки важных реплик с закладкой в БД
## US-088: Редактирование атрибутов протокола
- **Status:** Done
- **Файл:** `US_088.md`
- **Описание:** Модальное окно редактирования атрибутов протокола (title, chair, location, agenda, language)

## US-089: Remote Whisper сервер
- **Status:** Done (E251, E254)
- **Файл:** `US_089.md`
- **Описание:** UI-выбор источника транскрипции (локально или удалённый сервер), отправка аудио напрямую на remote URL с прогрессом

## Сводная таблица US (для pipeline-checker)

| US-ID | Название | Файл |
|-------|----------|------|
| US-079 | GPU ускорение Whisper | US_079.md |
| US-080 | Heartbeat прогресс | US_080.md |
| US-081 | Потоковая запись реплик | US_081.md |
| US-082 | UX-полировка | US_082.md |
| US-083 | Ручная пометка решений | US_083.md |
| US-084 | Pause/Resume | US_084.md |
| US-087 | Закладки Важное | US_087.md |
| US-088 | Редактирование атрибутов | US_088.md |
| US-089 | Remote Whisper | US_089.md |
